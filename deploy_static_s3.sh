...
# Deploy Static Adda247 Gold Landing Page to S3
# Usage: ./deploy_static_s3.sh <bucket-name>

set -e

if [ -z "$1" ]; then
  echo "❌ Error: Bucket name required"
  echo "Usage: ./deploy_static_s3.sh <bucket-name>"
  exit 1
fi

BUCKET_NAME=$1

echo "🚀 Deploying Static Adda247 Gold Landing Page to S3..."
...
echo ""
echo "🎯 This is the original Adda247 Gold landing page - static and S3 ready!"